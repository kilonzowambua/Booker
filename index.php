							...
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
                                ...
                                <li>
									...
									<li>
										...
										<div>kilonzowambua@gmail.com</div>
									</li>
								</ul>
								<div class="top_bar_login ml-auto">
									<div class="login_button"><a href="learner/login.php">Student</a></div>
								</div>
                                
									<div class="login_button"><a href="librarian/signin.php">Librarian</a></div>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col">
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							<div class="logo_container">
								<a href="#">
                                <div class="logo_text">Boo<span>ker</span></div>
								</a>
							</div>
						...
						<div class="container">
							<div class="row">
								<div class="col text-center">
									<div class="home_slider_title">Booker Library</div>
					...
					<div class="home_slider_content">
						<div class="container">
							<div class="row"><div class="back">
								...
								<div class="col text-center">
									<div class="home_slider_title">The Library System </div>
									<div class="home_slider_subtitle">Future Of Education Technology</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						<h2 class="section_title">Welcome To Boo<span>ker</span> </h2>
						<div class="section_subtitle"><p>Best online library for leading platform</p></div>
					</div>
				</div>
			</div>
			<div class="row features_row">
				...
				<div class="col-lg-3 feature_col">
					<div class="feature text-center trans_400">
						...
						<h3 class="feature_title">Books</h3>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="counter_content">
						...
						<div class="counter_text"><p>Please enroll to enjoy our cheap and best library on our hand</p></div>
						...
						<div class="milestones d-flex flex-md-row flex-column align-items-center justify-content-between">
							...
							<div class="milestone">
								...
								<div class="milestone_text">years ago</div>
							</div>

							<!-- Milestone -->
							<div class="milestone">
								<div class="milestone_counter" data-end-value="120">0</div>
								<div class="milestone_text">months ago</div>
							</div>

							<!-- Milestone -->
							<div class="milestone">
								<div class="milestone_counter" data-end-value="670">0</div>
								<div class="milestone_text">dates ago</div>
							</div>

							<!-- Milestone -->
							<div class="milestone">
								<div class="milestone_counter" data-end-value="320">0</div>
								<div class="milestone_text">hours ago</div>
							</div>
			...
			<div class="counter_form">
				...
				if(isset($_POST['addlearner'])){
							include 'librarian/includes/config.php';
							$lname = $_POST['lname'];
						  ...
						  move_uploaded_file($_FILES["limage"]["tmp_name"],"librarian/photos/".$_FILES["limage"]["name"]);
						  
$result = mysqli_query($conn,"SELECT * FROM  learner WHERE email = '$email'") or exit(mysqli_error()); //check for duplicates
$num_rows = mysqli_num_rows($result); //number of rows where duplicates exist

 if(($num_rows) > 0){
     echo "<script type = \"text/javascript\">
	 window.alert(\"Learner is already in our system.Check your email\");
	...
	?>
						<form class="counter_form_content d-flex flex-column align-items-center justify-content-center" enctype="multipart/form-data" method="post" action="#">
							<div class="counter_form_title">Register now
                            
                            </div>
							<input type="text" name="lname" class="counter_input" placeholder="Student name" required="required">
							<input type="email" name="email" class="counter_input" placeholder="Email" required="required">
							
                            <select name="levelofedu" id="counter_select" class="counter_input counter_options">
								<option>Choose Level</option>
								<option>Primary level</option>
								<option>Secondary level</option>
								<option>Tetairaly level</option>
		...
		<select name="location" id="counter_select" class="counter_input counter_options">
							...
							<input type="password" name="password" class="counter_input" placeholder="password" required="required">
							
							<input type="submit" name="addlearner" value="Join now"class="counter_form_button">
						</form>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col">
					<div class="section_title_container text-center">
						...
						<div class="section_subtitle"><p>The best authors for your best books.Answer any question about their books</p></div>
					</div>
				</div>
			</div>
						...
						<div class="row">
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_about">
									<div class="footer_logo_container">
										<a href="#">
											<div class="footer_logo_text">Boo<span>ker</span></div>
										</a>
									</div>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_contact">
                                    ...
                                    <ul>
											<li>Email: Kilonzowambua@gmail.com</li>
											<li>Phone:  0723135443</li>
											<li>Behind Mutisya Garden Machakos, Kenya</li>
										</ul>
									</div>
								</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This system is made with <i class="fa fa-heart-o" aria-hidden="true"></i><i class="fa fa-coffee" aria-hidden="true"></i><i class="fa fa-code" aria-hidden="true"></i> by <a href="https://kilonzowambua.github.io" target="_blank">Kilodev</a>
